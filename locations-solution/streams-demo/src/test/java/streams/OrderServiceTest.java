...
class OrderServiceTest {
    ...
    @Test
    void numberOfOrdersWithStatusTest() {
        long result =
                ordersService.countOrdersByStatus("pending");
        assertEquals(1, result);
    }

    @Test
    void numberOfOrdersWithStatusZeroTest() {
        long result =
                ordersService.countOrdersByStatus("prndingd");
